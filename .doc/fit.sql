...
CREATE TABLE `lms_paper` (
  ...
  `UUID` varchar(36) COLLATE utf8_unicode_ci DEFAULT 'UUID()',
...
insert  into `lms_paper`(`ID`,`CTIME`,`CUSER`,`UUID`,`EXAM_TYPE_ID`,`ADVICE_TIME`,`TITLE`,`INTRO`,`NOTES`,`SORT`,`ENABLED`,`ETIME`,`EUSER`) values (1,'2025-12-01 17:17:44',1,'97678948-c205-11f0-81f1-fcaa144e',NULL,10,'默认测试答卷','默认','默认',0,1,'2025-12-01 17:52:15',1);
insert  into `lms_paper`(`ID`,`CTIME`,`CUSER`,`UUID`,`EXAM_TYPE_ID`,`ADVICE_TIME`,`TITLE`,`INTRO`,`NOTES`,`SORT`,`ENABLED`,`ETIME`,`EUSER`) values (2,'2025-12-01 17:17:44',1,'b239086a-c205-11f0-81f1-fcaa144e',NULL,NULL,'测试答卷','测试答卷','测试答卷',1,0,'2025-12-01 17:25:06',1);
...
insert  into `lms_subject_know`(`ID`,`CTIME`,`CUSER`,`PID`,`NAME`,`CRUK`,`NOTES`,`SORT`,`ENABLED`,`ETIME`,`EUSER`) values (1,NULL,NULL,0,'演示科目','material',NULL,NULL,1,'2025-12-01 22:28:07',1);
insert  into `lms_subject_know`(`ID`,`CTIME`,`CUSER`,`PID`,`NAME`,`CRUK`,`NOTES`,`SORT`,`ENABLED`,`ETIME`,`EUSER`) values (2,NULL,NULL,1,'演示知识点','KNOW',NULL,NULL,1,'2025-12-02 10:49:13',1);
...
insert  into `lms_subject_material`(`ID`,`CTIME`,`CUSER`,`UUID`,`TITLE`,`CONTENT`,`NOTES`,`ENABLED`,`ETIME`,`EUSER`) values (2,'2017-11-11 00:00:00',1,'2df6c93e-cebc-11f0-8745-f8cab851439b','望庐山瀑布','<p>\r\n	日照香炉生紫烟，\r\n</p>\r\n<p>\r\n	遥看瀑布挂前川。\r\n</p>\r\n<p>\r\n	飞流直下三千尺，\r\n</p>\r\n<p>\r\n	疑是银河落九天。\r\n</p>',NULL,0,'2025-12-01 22:06:04',1);
...
insert  into `sys_resources`(`ID`,`CTIME`,`CUSER`,`PID`,`NAME`,`ICON`,`TYPE`,`URL`,`SORT`,`NOTES`,`LEVELS`,`ISMENU`,`ENABLED`,`ISYS`,`ETIME`,`EUSER`) values (20,'2017-11-11 00:00:00',NULL,16,'题库科目',NULL,'U','/admin/lms/subject/know/list',4,'题库科目列表',3,'Y',1,0,NULL,NULL);
insert  into `sys_resources`(`ID`,`CTIME`,`CUSER`,`PID`,`NAME`,`ICON`,`TYPE`,`URL`,`SORT`,`NOTES`,`LEVELS`,`ISMENU`,`ENABLED`,`ISYS`,`ETIME`,`EUSER`) values (21,'2017-11-11 00:00:00',NULL,16,'题库材料',NULL,'U','/admin/lms/subject/material/list',5,'题库材料列表',3,'Y',1,0,NULL,NULL);
insert  into `sys_resources`(`ID`,`CTIME`,`CUSER`,`PID`,`NAME`,`ICON`,`TYPE`,`URL`,`SORT`,`NOTES`,`LEVELS`,`ISMENU`,`ENABLED`,`ISYS`,`ETIME`,`EUSER`) values (22,'2017-11-11 00:00:00',NULL,0,'考卷管理',NULL,'U','#',5,'考卷管理',2,'Y',1,0,NULL,NULL);
