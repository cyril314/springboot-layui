...
public class SystemUtil {
    ...
    public static Map<String, Object> getOsInfo() {
        ...
        try {
            ...
            map.put("hostName", InetAddress.getLocalHost().getHostName().toString().trim());// 获取本机计算机名称
            map.put("osname", OS_NAME);
            map.put("version", OS_VERSION);
            map.put("arch", OS_ARCH);
            SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd");
            map.put("sysTime", sf.format(new Date()));
            map.put("userdir", USER_DIR);
            map.put("sysUserName", USER_NAME);
            map.put("computerName", COMPUTER_NAME);
    ...
    public static String getIp() {
        ...
        return addr.getHostAddress().toString().trim();
    }
