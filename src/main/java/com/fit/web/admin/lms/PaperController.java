 ...
 */
@Controller
@RequestMapping("/admin/lms/paper")
public class PaperController extends BaseController {

    private static String PREFIX = "/admin/lms/paper/";

    @Autowired
    private LmsPaperService service;
    @Autowired
    ...
    public Object list(HttpServletRequest request) {
        ...
        List<LmsPaper> list = this.service.findList(params);
    ...
    public String editView(Long id, Model model) {
        if (OftenUtil.isNotEmpty(id)) {
            LmsPaper bean = this.service.get(id);
    ...
    @PostMapping("/save")
    @ResponseBody
    public Object save(LmsPaper bean) {
        LmsPaper entity = this.service.get(bean.getId());
