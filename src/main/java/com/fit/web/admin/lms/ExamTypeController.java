...
import com.fit.entity.LmsExamType;
import com.fit.entity.LmsPaper;
import com.fit.service.LmsExamTypeService;
...
public class ExamTypeController extends BaseController {
    ...
    public Object list(HttpServletRequest request) {
        ...
        List<LmsExamType> list = this.service.findList(params);
    ...
    public String editView(Long id, Model model) {
        if (OftenUtil.isNotEmpty(id)) {
            LmsExamType bean = this.service.get(id);
            model.addAttribute("bean", bean);
        }
        return PREFIX + "typesEdit";
    }
    ...
    @PostMapping("/save")
    @ResponseBody
    public Object save(LmsExamType bean) {
        LmsExamType entity = this.service.get(bean.getId());
